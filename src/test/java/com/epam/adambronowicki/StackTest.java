...
public class StackTest {
  ...
  public void testPush() {
    Stack<String> list = new ArrayBasedStack<>(String.class);
    list.push("this");
    list.push("is");
    list.push("simple");
    list.push("test");
  ...
  public void testPeek() {
    Stack<Integer> list = new ArrayBasedStack<>(Integer.class);
    list.push(1);
    list.push(2);
    list.push(3);
    list.push(4);
    ...
    assertThat(list.peek(), is(equalTo(Integer.valueOf(5))));
  }
